...
public class SwitchButton extends CompoundButton {
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.SwitchButton, defStyle, 0);// �������ļ��л�ȡ�������
		...
		mTextOn = a.getText(R.styleable.SwitchButton_textOn);// ��ȡ������ ѡ������µ���ʾ����
																// on
		mTextOff = a.getText(R.styleable.SwitchButton_textOff);// ��ȡ���õ�
																// Ϊѡ������µ���ʾ����
																// off
		mThumbTextPadding = a.getDimensionPixelSize(
				R.styleable.SwitchButton_thumbTextPadding, 0);// ��ȡ���õİ�ť�����С
		mSwitchMinWidth = a.getDimensionPixelSize(
				R.styleable.SwitchButton_switchMinWidth, 0);// ��ȡ���õ���С���
		mSwitchPadding = a.getDimensionPixelSize(
				R.styleable.SwitchButton_switchPadding, 0);// ��ȡ���õ�padding����

		int appearance = a.getResourceId(
				R.styleable.SwitchButton_switchTextAppearance, 0);// ��ȡ�����ļ��л�ȡ��ʾ�����ʽ
		// �ж��趨��ʽ�Ƿ���ڣ����ڵĻ��͸�ֵ
		if (appearance != 0) {
